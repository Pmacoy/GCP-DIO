...
resource "google_project" "podebater2-salesforce-dev" {
  name       = "SalesForce-Dev"
  project_id = "podebater2-salesforce-dev"
...
# resource "google_project" "podebater-salesforce-prod" {
#   name       = "SalesForce-Prod"
#   project_id = "podebater-salesforce-prod"
